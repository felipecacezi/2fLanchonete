        ...
        <div class="flex
            ...
            <div class="w-full
                ...
                <div class="flex gap-4">
                    ...
                    <input type="hidden" name="file_id" id="file_id" value="{{ $arProduct['file_id'] }}">
                ...
                <div class="">
                    ...
                    <x-text-area id="product_description"
                        ...
                        placeholder="Descrição do produto">
                            <x-slot:teste>{{$arProduct['product_description']}}</x-slot>
                    </x-text-area>
                ...
                <div class="mt-3">
                    <label for="product_active"
                        ...
                        name="product_active"
                        {{ $arProduct['product_active'] == 'a' ? 'checked' : '' }} />
